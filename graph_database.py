...
class KnowledgeGraph(KnowledgeBase):
    ...
    def _execute_relation_query(self, query: Text) -> List[Dict[Text, Any]]:
        """
    ...
    def get_relations(
        self, rel_type="", entity_type="", attributes: Optional[Dict[Text, Text]] = None
    ):
        """

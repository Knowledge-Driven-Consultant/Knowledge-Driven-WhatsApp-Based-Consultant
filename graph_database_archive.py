...
class KnowledgeGraph(KnowledgeBase):
    ...
    def get_entity_properties(self, entity_type: Text, entity: Text):

        return self._execute_entity_query(
            f"""
            match (n: {entity_type} {{n4sch__name: "{entity}"}}) 
            return properties(n)
            """
        )
...
#     )
#     print(q.get_entity_properties("n4sch__Class", "MoneyMarketFund"))
